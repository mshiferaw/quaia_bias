...
#SBATCH --job-name=G20.5_b20_Lsplit4_wtheta_jackknife
...
python -u jackknife.py wtheta 20.5 0.001 10 30 log --L_method split 50 --b 20 Planck --z_bins 0.0 1.0 2.0 3.0 4.6 --n_Lbins 4
