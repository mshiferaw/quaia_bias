...
# python -u clustering.py wtheta 20.5 0.001 5 27 log --L max 0.5 --z_bins 0.0 1.0 2.0 3.0 4.6 #20 30 180 30 linear #1 200 14 log
# python -u clustering.py wtheta 20.5 0.001 5 27 log --L max --mask 0 _ --z_bins 0.0 1.0 2.0 3.0 4.6 #20 30 180 30 linear #1 200 14 log
# python -u clustering.py wp 20.5 30 180 30 linear minmax 0.5 --z_bins 0.0,1.0,2.0,3.0,4.6 #1 200 14 log
python -u clustering.py wp 20.5 30 180 30 linear --L minmax _MC_ --b 30 Planck --z_bins 0.0 1.0 2.0 3.0 4.6 #1 200 14 log
