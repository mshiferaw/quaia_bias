...
# for G_max in '20.5' '20.0'
# do 
#     for Lbin in '0' '1' '2' '3'
#     do
#         fn_gcat_Lbin="../data/quaia_G${G_max}_Lsplit4bin${L_bin}${save_tag}.fits"
#         fn_selfunc="../data/maps/selection_function_NSIDE64_G${G_max}_Lsplit4bin${Lbin}${save_tag}.fits"
        
#         cat > sel_func_Lsplit4bin${L_bin}.sh << EOF
# #!/bin/bash
# #SBATCH --partition=kipac
# #SBATCH --job-name=sel_func_G${G_max}_Lsplit4bin${Lbin}${save_tag}
# #SBATCH --output=logs/%x.out
# #SBATCH --nodes=1
# #SBATCH --cpus-per-task=48
# ##SBATCH --mem=175GB
...
#         sbatch sel_func_Lsplit4bin${Lbin}.sh
#     done
# done
