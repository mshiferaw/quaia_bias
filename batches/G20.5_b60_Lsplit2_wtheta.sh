...
#SBATCH --job-name=G20.5_b60_Lsplit2_wtheta
...
python -u clustering.py wtheta 20.5 0.001 10 30 log --L_method split _MC_ --b 60 Planck --z_bins 0.0 1.0 2.0 3.0 4.6 --n_Lbins 2
