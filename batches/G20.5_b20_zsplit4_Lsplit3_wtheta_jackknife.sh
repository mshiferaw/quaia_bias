...
#SBATCH --job-name=G20.5_b20_zsplit4_Lsplit3_wtheta_jackknife
...
python -u jackknife.py wtheta 20.5 0.001 10 30 log --L_method split 50 --b 20 Planck --n_zbins 4 --n_Lbins 3
