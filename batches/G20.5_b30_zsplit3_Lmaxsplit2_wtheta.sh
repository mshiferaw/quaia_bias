...
#SBATCH --job-name=G20.5_b30_zsplit3_Lmaxsplit2_wtheta
...
python -u clustering.py wtheta 20.5 0.001 10 30 log --L_method maxsplit _MC_ --b 30 Planck --n_zbins 3 --n_Lbins 2
